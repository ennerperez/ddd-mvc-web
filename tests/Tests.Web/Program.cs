  ...
  internal class Program
  {
    ...
    internal static void LoadBrowserDriver(string browser = "")
    {
      ...
      if (string.IsNullOrWhiteSpace(browser) || browser == "Chrome")
      {
        ...
        if (browserSettings.Maximized) driver.Manage().Window.Maximize();
        else if (browserSettings.Size.Any()) driver.Manage().Window.Size = new Size(browserSettings.Size[0], browserSettings.Size[1]);
